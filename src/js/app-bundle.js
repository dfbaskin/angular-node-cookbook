...
(['js/app/mainCtrl'], function(System) {
...
System.register('js/app/appModule', ['github:angular/bower-angular@1.3.15'], function (_export) {
  'use strict';
  ...
  return {
    ...
    execute: function () {
      ...
      _export('default', mainApp);
    }
  };
});
System.register('js/app/mainCtrl', ['npm:babel-runtime@5.4.2/helpers/class-call-check', 'js/app/appModule'], function (_export) {
    var _classCallCheck, appModule, MainCtrl;

    return {
        setters: [function (_npmBabelRuntime542HelpersClassCallCheck) {
            _classCallCheck = _npmBabelRuntime542HelpersClassCallCheck['default'];
        }, function (_jsAppAppModule) {
            appModule = _jsAppAppModule['default'];
        }],
        execute: function () {
            'use strict';

            MainCtrl = function MainCtrl() {
